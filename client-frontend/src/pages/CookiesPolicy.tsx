  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black to-gray-900 text-white py-12 px-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-center text-orange-500 mb-8">Cookies Policy</h1>
        ...
        <h2 className="text-2xl font-bold text-orange-500 mb-4">What are cookies?</h2>
        <p className="text-gray-400 mb-6">
        ...
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Why do we use cookies?</h2>
        <p className="text-gray-400 mb-6">
        ...
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Types of cookies we use</h2>
        ...
        <h2 className="text-2xl font-bold text-orange-500 mb-4">Your choices regarding cookies</h2>
        <p className="text-gray-400 mb-6">
