  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 to-black text-white">
      ...
      <section className="py-12 px-4 md:px-16">
        <h2 className="text-2xl font-bold mb-6 text-center text-orange-500">Frequently Asked Questions</h2>
        <div className="max-w-4xl mx-auto space-y-6">
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-orange-500">What is Learn2Pay?</h3>
          ...
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-orange-500">How can I register as a parent or an institution?</h3>
            <p className="text-gray-400 mt-2">
              Registration is simple. Visit our Registration page and select your category to fill out the necessary details.
            </p>
          </div>
          <div className="bg-gray-800 p-6 rounded-lg shadow-md">
            <h3 className="text-lg font-semibold text-orange-500">What are the EMI terms?</h3>
            <p className="text-gray-400 mt-2">
      ...
      <section className="py-12 bg-gray-800 px-4 md:px-16">
        <h2 className="text-2xl font-bold mb-6 text-center text-orange-500">Need More Help?</h2>
        <div className="max-w-2xl mx-auto bg-black p-6 rounded-lg shadow-lg">
          ...
          <div className="space-y-4">
            <p className="text-gray-400">
              <strong>Email:</strong> <a href="mailto:support@learn2pay.com" className="text-orange-500">support@learn2pay.com</a>
            </p>
            <p className="text-gray-400">
