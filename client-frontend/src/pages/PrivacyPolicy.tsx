  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gradient-to-br dark:from-black dark:to-gray-900 text-gray-900 dark:text-white">
      ...
      <section className="py-12 px-4 md:px-16">
        <h2 className="text-2xl font-bold mb-6 text-center text-orange-600 dark:text-orange-400">Our Commitment</h2>
        <div className="max-w-3xl mx-auto text-gray-700 dark:text-gray-400">
          <p className="mb-4">
      ...
      {/* Key Sections */}
      <section className="py-12 px-4 md:px-16">
        <h2 className="text-2xl font-bold mb-6 text-center text-orange-600 dark:text-orange-400">Key Points</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-lg font-semibold text-orange-600 dark:text-orange-400 mb-4">Data Collection</h3>
            <p className="text-gray-700 dark:text-gray-400">
              We collect information to provide better services, including data you provide and data collected automatically.
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-lg font-semibold text-orange-600 dark:text-orange-400 mb-4">Data Usage</h3>
            <p className="text-gray-700 dark:text-gray-400">
              Your information is used to enhance our services, ensure security, and deliver personalized experiences.
            </p>
          </div>
          <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-lg">
            <h3 className="text-lg font-semibold text-orange-600 dark:text-orange-400 mb-4">Data Protection</h3>
            <p className="text-gray-700 dark:text-gray-400">
      ...
      <section className="py-12 bg-gray-100 dark:bg-gray-800 px-4 md:px-16">
        <h2 className="text-2xl font-bold mb-6 text-center text-orange-600 dark:text-orange-400">Contact Us</h2>
        <div className="max-w-2xl mx-auto text-gray-700 dark:text-gray-400">
          <p className="mb-4">
            If you have any questions about this Privacy Policy, please reach out to us.
          </p>
          <p>
            <strong>Email:</strong> <a href="mailto:privacy@learn2pay.com" className="text-orange-600 dark:text-orange-400">privacy@learn2pay.com</a>
          </p>
          <p>
