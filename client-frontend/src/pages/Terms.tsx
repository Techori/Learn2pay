  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gradient-to-br dark:from-black dark:to-gray-900 text-gray-900 dark:text-white">
      ...
      <section className="py-12 px-4 md:px-16">
        <h2 className="text-2xl font-bold mb-6 text-orange-600 dark:text-orange-400">Introduction</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-6">
          Welcome to Learn2Pay. By accessing and using our services, you agree to the following terms and conditions.
        </p>

        <h2 className="text-2xl font-bold mb-6 text-orange-600 dark:text-orange-400">Usage of Services</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-6">
          Our platform is designed to simplify fee payment processes. Any misuse of our services is strictly prohibited.
        </p>

        <h2 className="text-2xl font-bold mb-6 text-orange-600 dark:text-orange-400">User Responsibilities</h2>
        ...
        <h2 className="text-2xl font-bold mb-6 text-orange-600 dark:text-orange-400">Privacy Policy</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-6">
          Please refer to our <a href="/privacy" className="text-orange-600 dark:text-orange-400">Privacy Policy</a> for details on how we handle your data.
        </p>

        <h2 className="text-2xl font-bold mb-6 text-orange-600 dark:text-orange-400">Termination of Services</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-6">
          We reserve the right to suspend or terminate accounts in case of violations of our terms.
        </p>

        <h2 className="text-2xl font-bold mb-6 text-orange-600 dark:text-orange-400">Limitation of Liability</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-6">
          Learn2Pay shall not be held liable for any indirect or consequential damages arising from the use of our services.
        </p>

        <h2 className="text-2xl font-bold mb-6 text-orange-600 dark:text-orange-400">Governing Law</h2>
        <p className="text-gray-700 dark:text-gray-300 mb-6">
      ...
      <section className="py-12 bg-orange-600 text-white text-center">
        ...
        <button
          ...
          className="bg-white text-orange-600 px-6 py-3 rounded-lg font-semibold hover:bg-gray-200 transition-colors"
        >
          Contact Us
        </button>
      </section>
