  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        theme === "dark" 
          ? "border-gray-700 bg-gray-800 text-gray-200 focus:ring-gray-600 focus:ring-offset-gray-900" 
          : "border-gray-200 bg-white text-gray-900 focus:ring-gray-300 focus:ring-offset-white",
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDown className={cn("h-4 w-4", theme === "dark" ? "opacity-70" : "opacity-50")} />
