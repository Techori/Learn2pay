      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Latest support requests from institutes</CardDescription>
          </CardHeader>
          <CardContent>
              ...
              {recentTickets.map((ticket, index) => (
                ...
                >
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-gray-500">{ticket.institute} • {ticket.time}</p>
                  </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Performance across different support channels</CardDescription>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              {supportChannels.map((channel, index) => (
                <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                  <div className="flex items-center space-x-3">
                    <div className="text-blue-500">{channel.icon}</div>
                    <div>
                      <p className="font-medium">{channel.channel}</p>
                      <p className="text-sm text-gray-500">{channel.requests} requests today</p>
                    </div>
                  </div>
