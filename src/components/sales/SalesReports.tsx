...
const SalesReports = () => {
  ...
  const handleExportPDF = () => {
    ...
    if (selectedReport === "performance") {
      ...
      doc.autoTable({
        ...
        body: revenueBreakdown.map(r => [r.source, r.amount, r.percentage + "%"])
      });
    } else if (selectedReport === "conversion") {
      doc.text("Conversion Funnel", 10, 10);
      doc.autoTable({
        head: [["Stage", "Count", "Percentage"]],
        body: conversionFunnel.map(c => [c.stage, c.count, c.percentage + "%"])
      });
  ...
  const handleExportExcel = () => {
    let ws, wb;
    if (selectedReport === "performance") {
      ws = XLSX.utils.json_to_sheet(performanceMetrics.map(m => ({
        Metric: m.label,
        Value: m.value,
        Change: m.change
      })));
    } else if (selectedReport === "revenue") {
      ws = XLSX.utils.json_to_sheet(revenueBreakdown.map(r => ({
        Source: r.source,
        Amount: r.amount,
        Percentage: r.percentage
      })));
    } else if (selectedReport === "conversion") {
      ws = XLSX.utils.json_to_sheet(conversionFunnel.map(c => ({
        Stage: c.stage,
        Count: c.count,
    ...
    <div className="space-y-6 bg-[#101624] min-h-screen p-4 rounded-xl text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mt-6">
            <Card className="bg-[#181f32] border border-[#232b45] shadow-none text-white">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-[#232b45] rounded-lg">
                  <div className="text-sm text-gray-400">Revenue per Sales Rep</div>
                  <div className="flex items-center justify-between mt-1">
                ...
                <div className="p-4 bg-[#232b45] rounded-lg">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    ...
                    <div className="text-sm text-red-400">↘ +5% vs last month</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className="bg-green-900 text-green-300">₹12,50,000</Badge>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className="bg-blue-900 text-blue-300">₹6,30,000</Badge>
                  </div>
                  <div className="w-full bg-[#232b45] rounded-full h-2 mb-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className="bg-purple-900 text-purple-300">₹3,60,000</Badge>
                  </div>
                  <div className="w-full bg-[#232b45] rounded-full h-2 mb-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className="bg-orange-900 text-orange-300">₹1,60,000</Badge>
                  </div>
      ...
      {selectedReport === 'team' && (
        <>
          <Card className="bg-[#181f32] border border-[#232b45] shadow-none text-white">
            <CardHeader>
              <CardTitle className="text-white">Individual Performance Table</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            <Card className="bg-[#181f32] border border-[#232b45] shadow-none text-white">
              <CardHeader>
                <CardTitle className="text-white">Team Analytics Dashboard</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid grid-cols-2 gap-4">
                  <div className="p-4 bg-[#232b45] rounded-lg">
                    <div className="text-sm text-gray-400">Total Revenue</div>
                    <div className="text-2xl font-bold mt-1 text-white">₹28,45,000</div>
                  </div>
                  <div className="p-4 bg-[#232b45] rounded-lg">
                    <div className="text-sm text-gray-400">Average Conversion Rate</div>
                    <div className="text-2xl font-bold mt-1 text-white">25.8%</div>
                  </div>
                  <div className="p-4 bg-[#232b45] rounded-lg">
                    <div className="text-sm text-gray-400">Total Leads</div>
                    <div className="text-2xl font-bold mt-1 text-white">628</div>
                  </div>
                  <div className="p-4 bg-[#232b45] rounded-lg">
                    <div className="text-sm text-gray-400">Total Conversions</div>
                    <div className="text-2xl font-bold mt-1 text-white">163</div>
                  </div>
                </div>
                <div className="mt-6 p-4 bg-[#232b45] rounded">
                  <div className="text-lg font-bold text-orange-400">Overall Team Performance Rating</div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
            <Card className="bg-[#181f32] border border-[#232b45] shadow-none text-white">
              <CardHeader>
                <CardTitle className="text-white">Team Efficiency Metrics</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="p-4 bg-[#232b45] rounded-lg">
                ...
                <div className="p-4 bg-[#232b45] rounded-lg">
                  <div className="text-sm text-gray-400">Daily Call Metrics</div>
                  <div className="flex items-center justify-between mt-1">
                ...
                <div className="p-4 bg-[#232b45] rounded-lg">
                  ...
                  <div className="flex items-center justify-between mt-1">
                    ...
                    <div className="text-sm text-red-400">+2 days vs target</div>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className="bg-green-900 text-green-300">High Impact</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white">Deal Size Improvement</span>
                    <Badge className="bg-blue-900 text-blue-300">Medium Impact</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white">Geographic Expansion</span>
                    <Badge className="bg-purple-900 text-purple-300">Low Impact</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <Badge className="bg-green-900 text-green-300">High Priority</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white">Mentorship Program</span>
                    <Badge className="bg-blue-900 text-blue-300">Medium Priority</Badge>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-white">Incentive Structure</span>
                    <Badge className="bg-purple-900 text-purple-300">Low Priority</Badge>
                  </div>
                </div>
              </CardContent>
            </Card>
