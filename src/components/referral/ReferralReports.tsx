...
import { BarChart3, Download, Calendar, TrendingUp, Users, DollarSign, Target, Eye } from 'lucide-react';
...
const ReferralReports = () => {
  ...
  const quickMetrics = [
    { label: "Total Referrals", value: "89", period: "All Time", trend: "+12%" },
    { label: "Conversion Rate", value: "26%", period: "This Month", trend: "+3%" },
    { label: "Revenue Generated", value: "₹4,56,000", period: "YTD", trend: "+18%" },
    { label: "Active Institutes", value: "23", period: "Current", trend: "+5%" }
  ];

  const performanceData = [
    { metric: "Lead Generation", thisMonth: 35, lastMonth: 28, change: "+25%" },
    { metric: "Successful Onboarding", thisMonth: 8, lastMonth: 6, change: "+33%" },
    { metric: "Revenue per Referral", thisMonth: "₹19,826", lastMonth: "₹18,200", change: "+9%" },
    { metric: "Follow-up Response Rate", thisMonth: "78%", lastMonth: "71%", change: "+7%" }
  ];

  const topPerformers = [
    { category: "Schools", count: 12, revenue: "₹1,80,000", conversion: "32%" },
    { category: "Colleges", count: 8, revenue: "₹1,40,000", conversion: "28%" },
    { category: "Coaching Centers", count: 6, revenue: "₹90,000", conversion: "24%" },
    { category: "Universities", count: 3, revenue: "₹75,000", conversion: "30%" }
  ];

  // Add state for custom report builder selections
  const [customReportType, setCustomReportType] = useState('Performance Summary');
  ...
  const onDownloadReport = (reportTitle: string) => {
    ...
    const selectedReport = reportTypes.find(report => report.title === reportTitle);
    ...
    if (reportTitle === "Monthly Performance Report") { // Example: add a list for this specific report
        yPos += 10;
    ...
    <div className="space-y-6">
              ...
              return (
                <div key={index} className="flex items-center justify-between p-4 border rounded-lg hover:bg-gray-50 transition-colors duration-200">
                  <div className="flex items-center space-x-4">
                    ...
                    <div>
                      ...
                      <div className="flex items-center space-x-4 mt-2">
                        ...
                        <Badge variant="outline" className="text-gray-700">{report.frequency}</Badge>
                      </div>
                    </div>
                  </div>
                  <div className="flex items-center space-x-2">
                    ...
                    <Button size="sm" variant="outline" disabled={report.status !== 'Available'} className="border-gray-300 hover:bg-gray-100" onClick={() => onDownloadReport(report.title)}>
                      <Download className="h-4 w-4 mr-1" />
                      Download
                    </Button>
                    <Button size="sm" variant="outline" className="border-gray-300 hover:bg-gray-100" onClick={() => onViewReport(report.title)}>
      ...
      <Card className="shadow-sm">
        <CardHeader className="pb-4">
          ...
          <CardDescription>Month-over-month performance analysis</CardDescription>
        </CardHeader>
        <CardContent className="pt-0">
              ...
              <div key={index} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200">
                ...
                <div className="flex items-center space-x-6">
                  <div className="text-center">
                    ...
                    <div className="font-bold text-gray-900">{item.thisMonth}</div>
                  </div>
                  <div className="text-center">
                    <div className="text-sm text-gray-600">Last Month</div>
                    <div className="font-bold text-gray-900">{item.lastMonth}</div>
                  </div>
                  <div className="text-center">
              ...
              {topPerformers.map((performer, index) => (
                <div key={index} className="p-4 border rounded-lg hover:bg-gray-50 transition-colors duration-200">
                  <div className="flex items-center justify-between mb-3">
                    <h4 className="font-semibold text-gray-900">{performer.category}</h4>
                    <Badge variant="outline" className="text-gray-700">{performer.count} institutes</Badge>
                  </div>
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    <div>
                      <span className="text-gray-600">Revenue:</span>
                      <span className="font-medium ml-2 text-green-600">{performer.revenue}</span>
                    </div>
                    <div>
                      <span className="text-gray-600">Conversion:</span>
                      <span className="font-medium ml-2 text-blue-600">{performer.conversion}</span>
                    </div>
                  </div>
                </div>
              ))}
          ...
          <CardContent className="space-y-5">
            <div className="space-y-4">
              <div>
                ...
                <select className="w-full p-2 border border-gray-300 rounded-md mt-1 focus:ring focus:ring-blue-200 focus:border-blue-500" value={customReportType} onChange={(e) => setCustomReportType(e.target.value)}>
              ...
              <div>
                ...
                <select className="w-full p-2 border border-gray-300 rounded-md mt-1 focus:ring focus:ring-blue-200 focus:border-blue-500" value={customDateRange} onChange={(e) => setCustomDateRange(e.target.value)}>
              ...
              <div>
                ...
                <select className="w-full p-2 border border-gray-300 rounded-md mt-1 focus:ring focus:ring-blue-200 focus:border-blue-500" value={customFormat} onChange={(e) => setCustomFormat(e.target.value)}>
                  <option>PDF</option>
                  <option>Excel</option>
                  <option>CSV</option>
                </select>
            ...
            <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white" onClick={onGenerateCustomReport}>
