  ...
  return (
    <Card className="bg-gray-800/50 border-gray-700 shadow-md">
      <CardHeader>
        ...
        <CardDescription className="text-gray-400">View all past payment transactions</CardDescription>
      </CardHeader>
            ...
            <tbody className="divide-y divide-gray-800">
              {paymentRecords.map((record, index) => (
                <tr key={index} className="hover:bg-gray-800/70">
                  <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-white">{record.transactionId}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm font-medium text-white">{record.studentName}</div>
                    <div className="text-xs text-gray-400">{record.studentId}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-white">{record.amount}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-white">{record.date}</td>
                  <td className="px-6 py-4 whitespace-nowrap text-sm text-white">{record.method}</td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <Badge
                      className={
