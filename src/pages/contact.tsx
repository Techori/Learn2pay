          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {contactInfo.map((info, index) => (
                <Card key={index} className="bg-gradient-to-br from-gray-900/80 to-gray-800/50 border-orange-500/20 shadow-md hover:scale-105 transition-transform duration-300">
          ...
          <div>
            ...
            <div className="space-y-3">
              {supportTypes.map((type, index) => (
                <Card key={index} className="bg-gradient-to-br from-gray-900/80 to-gray-800/50 border-orange-500/20 hover:border-orange-500/50 hover:scale-105 transition-all duration-300 shadow-md">
                  <CardContent className="p-4">
      ...
      <section className="py-14 px-4 bg-gradient-to-r from-orange-600/10 via-orange-500/5 to-orange-600/10">
        <div className="container mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-lg text-gray-300">Quick answers to common questions about our fee management system</p>
          </div>
